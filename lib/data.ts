...
const dataFr: PortfolioData = {
  ...
  professional: {
    ...
    about:
      "Formation en informatique (BUT) et certification développeur d'applications décentralisées (Alyra). Développeur Full Stack : conception d'architectures web front-end (React, Next.js) et de services back-end (Node.js, NestJS), interfaces utilisateur responsives, API REST/GraphQL et bases de données (PostgreSQL, MongoDB). Sérieux et autonome - cofondateur de Snowledge et refontes techniques en stage. Je recherche un poste Full Stack (remote ou Montauban / Toulouse) pour mener des projets de la conception à la production, avec rigueur et une communication claire.",
    goal: "Recherche un poste Full Stack (remote ou Montauban / Toulouse), disponible dès janvier 2025.",
  },
  education: [
    {
  ...
  experience: [
    {
      ...
      type: "Startup",
      points: [
        "Cofondation d'une plateforme d'analyse de contenu multi-plateforme pilotée par l'IA (Discord, YouTube, WhatsApp), conception de l'architecture front-end avec Next.js et composants UI responsives, mise en place des services back-end avec NestJS et PostgreSQL/MongoDB, définition des API REST/GraphQL.",
        "Gestion du déploiement et de l'hébergement sur Google Cloud Platform / OVH, maintenance des pipelines CI/CD et de la configuration serveur, collaboration avec les designers pour l'UX et les visuels.",
      ],
    },
    {
      ...
      type: "Stage",
      points: [
        "Pilotage de la refonte de l'intranet hospitalier : migration de Joomla vers un CMS sur mesure (Next.js, TypeScript, Prisma, PostgreSQL), mise en place de la gestion de contenu par rôles et de composants UI responsives.",
        "Recueil des besoins auprès des parties prenantes cliniques et administratives, simplification des flux de publication et amélioration de l'accessibilité multi-plateforme (bureau et mobile).",
      ],
    },
    {
      role: "Stagiaire développeur",
      ...
      type: "Stage",
      points: [
        "Développement du code client et serveur pour l'interface web d'une application telle que conçue par l'équipe produit : composants front-end, intégration d'API REST et connexion aux bases SQL.",
        "Garantie de la compatibilité multi-navigateurs et des mises en page responsives, collaboration avec les designers pour affiner les interactions utilisateur.",
      ],
    },
  ],
  projects: [
    {
      ...
      name: "Snowledge",
      description:
        "Associé & cofondateur depuis janvier 2025. Analyse de contenu multi-plateforme pilotée par l'IA (Discord, YouTube, WhatsApp). Front-end Next.js et TypeScript, back-end NestJS, données PostgreSQL et MongoDB.",
      longDescription:
    ...
    },
    {
      ...
      categories: ["web-app"],
      liveUrl: "https://giteperigord.net/",
      repoUrl: "https://github.com/Alexandre-Pascal/airbnb-dordogne",
      image: "/images/projects/gites-perigord/gites-perigord-01.png",
      gallery: [
        {
          src: "/images/projects/gites-perigord/gites-perigord-01.png",
          caption: "Hero - Séjour d'exception en Périgord Noir",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-02.png",
          caption: "Nos logements - Les Glycines",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-03.png",
          caption: "La Maisonnette - détail et galerie",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-04.png",
          caption: "L'expérience du domaine - espaces communs et intimité",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-05.png",
          caption: "La région - Découvrir le Périgord Noir",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-06.png",
          caption: "Randonnées, nature et gastronomie",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-07.png",
          caption: "Demande de réservation - calendrier et formulaire",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-08.png",
          caption: "Contact - carte et coordonnées",
        },
      ],
    },
    {
      ...
      description:
        "Refonte de l'intranet hospitalier en CMS sur mesure : migration du contenu Joomla vers Next.js avec TypeScript, React, Prisma et PostgreSQL, interface d'administration responsive et flux de publication.",
      categories: ["web-app"],
      longDescription:
    ...
    },
    {
      ...
      description:
        "Concept store (œuvres d'art, créations locales) avec authentification NFT, token $LDR et marketplace. Smart contracts en Solidity avec Hardhat, front Next.js, indexation des événements avec The Graph, paiements Stripe.",
    ...
    },
    {
      ...
      name: "ArbiRange",
      description:
        "Robo-advisor DeFi en cours de développement : Vault Uniswap V3 sur Arbitrum, flux dépôt/retrait et front Next.js. Smart contracts en Solidity, tests avec Foundry.",
      longDescription:
    ...
    },
    {
      ...
      name: "Valpineta",
      description:
        "Projet tutoré BUT 3e année : application mobile pour le refuge de Pineta et les randonneurs - cartes, accès hors ligne et planification d'itinéraires. React Native, Expo et TypeScript, MobX et react-native-maps.",
      categories: ["mobile"],
      longDescription:
  ...
  skills: [
    ...
    {
      name: "Bases de données & serveurs",
    ...
    {
      name: "Compétences transversales / processus",
      items: [
...
const dataEn: PortfolioData = {
  ...
  professional: {
    ...
    subtitle: "React, Next.js, Node.js · Solidity",
    about:
      "Background in computer science (bachelor’s degree) and blockchain developer certification (Alyra). Full Stack developer building front-end web architecture (React, Next.js) and back-end services (Node.js, NestJS); design responsive user interfaces, REST/GraphQL APIs and databases (PostgreSQL, MongoDB). Reliable and autonomous - co-founded Snowledge and led technical overhauls during internships. Seeking a Full Stack role (remote or Montauban / Toulouse) where I can take projects from conception to production with strong attention to detail and clear communication with designers and stakeholders.",
    goal: "Seeking a Full Stack role (remote or Montauban / Toulouse), available from January 2025.",
  },
  education: [
    {
  ...
  experience: [
    {
      ...
      type: "Startup",
      points: [
        "Co-founded an AI-driven multi-platform content analysis platform (Discord, YouTube, WhatsApp); designed front-end architecture with Next.js and responsive UI components, implemented back-end services with NestJS and PostgreSQL/MongoDB, and defined REST/GraphQL APIs.",
        "Managed deployment and hosting on Google Cloud Platform / OVH, maintained CI/CD workflows and server configuration, and collaborated with designers to define UX and visual assets.",
        "Coordinated product roadmap and feature prioritization across engineering and product teams to deliver end-to-end solutions.",
      ],
    },
    {
      ...
      type: "Internship",
      points: [
        "Led overhaul of the hospital intranet, migrating from Joomla to a custom CMS built with Next.js, TypeScript, Prisma and PostgreSQL; implemented role-based content management and responsive UI components.",
        "Gathered requirements from clinical and administrative stakeholders, streamlined content publishing workflows, and improved cross-platform accessibility for staff on desktop and mobile.",
      ],
    },
    {
      role: "Developer Intern",
      ...
      type: "Internship",
      points: [
        "Developed client- and server-side code for a web application interface as designed by the product team: implemented front-end components, integrated REST APIs and connected to SQL databases.",
        "Ensured cross-browser compatibility and responsive layouts, and collaborated with product designers to refine user interactions.",
      ],
    },
  ],
  projects: [
    {
      ...
      name: "Snowledge",
      description:
        "Associate & co-founder since January 2025. AI-driven multi-platform content analysis (Discord, YouTube, WhatsApp). Built front-end with Next.js and TypeScript, back-end with NestJS, data storage in PostgreSQL and MongoDB.",
      longDescription:
    ...
    },
    {
      ...
      gallery: [
        {
          src: "/images/projects/gites-perigord/gites-perigord-01.png",
          caption: "Hero - Exceptional stay in Périgord Noir",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-02.png",
          caption: "Our accommodations - Les Glycines",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-03.png",
          caption: "La Maisonnette - detail and gallery",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-04.png",
          caption: "The domain experience - shared areas and privacy",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-05.png",
          caption: "The region - Discover Périgord Noir",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-06.png",
          caption: "Hiking, nature and gastronomy",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-07.png",
          caption: "Reservation request - calendar and form",
        },
        {
          src: "/images/projects/gites-perigord/gites-perigord-08.png",
          caption: "Contact - map and details",
        },
      ],
    },
    {
      ...
      name: "Intranet CH Cahors",
      description:
        "Hospital intranet overhaul into a custom CMS: migrated content from Joomla to Next.js with TypeScript, React, Prisma and PostgreSQL; implemented responsive admin UI and content workflows.",
      categories: ["web-app"],
      longDescription:
    ...
    },
    {
      ...
      description:
        "Concept store (art, local creations) with NFT authenticity, $LDR token and marketplace. Smart contracts in Solidity with Hardhat; front-end in Next.js; indexed events with The Graph; payments via Stripe.",
      categories: ["web3", "web-app"],
      longDescription:
    ...
    },
    {
      ...
      name: "ArbiRange",
      description:
        "DeFi robo-advisor in development: Uniswap V3 Vault on Arbitrum with deposit/withdraw flows and front-end in Next.js. Smart contracts in Solidity, testing with Foundry.",
      categories: ["web3"],
      longDescription:
    ...
    },
    {
      ...
      name: "Valpineta",
      description:
        "Third-year group project (BUT): mobile app for Refuge de Pineta and hikers - maps, offline access and route planning. Built with React Native, Expo and TypeScript; state management with MobX and maps via react-native-maps.",
      categories: ["mobile"],
      longDescription:
  ...
  skills: [
    ...
    {
      name: "Transversal / process skills",
      items: [
        { name: "Agile methods" },
